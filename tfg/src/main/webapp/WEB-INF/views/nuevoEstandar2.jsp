...
<body id="top">
	...
	<div id="Main">
		<section>
			...
			<p></p>
			<h4>Crear nuevo estándar</h4>
			<sf:form id="crear_estandar_form" method="POST"
				modelAttribute="estandar" class="form-estandar"
				onsubmit="return validateForm()">
				<div class="row uniform 50%">
					<div class="12u$">
						<sf:input type="text" path="nombre" name="nombre_estandar"
							id="nombre_estandar" value="" placeholder="Nombre" />
					</div>
					<div class="12u$">
						<ul class="actions">
							<li><input id="parametro_button" type="submit"
								value="Crear estandar" class="special" /></li>
						</ul>
					</div>
				</div>
			</sf:form>
